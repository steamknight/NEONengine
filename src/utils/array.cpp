...
namespace NEONengine
{
    ...
    {
        ULONG ulTotalSize = sizeof(_Array) + (ulElementSize * ulLength);
        auto array = alloc<_Array>(ulTotalSize, ulFlags);
    ...
    void arrayDestroy(Array *pArray)
    {
        ...
        ULONG ulTotalSize = sizeof(_Array) + ((*pArray)->ulElementSize * (*pArray)->ulLength);
